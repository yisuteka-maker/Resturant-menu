...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 min-h-screen pb-20 md:pb-0 transition-colors duration-300">
    ...
    <!-- JAVASCRIPT CODE -->
    <script>
        // --- 1. MENU CATEGORIES & COMPLETE DATASET WITH LOCAL IMAGES ---
        const CATEGORIES = [
        ...
        let initialMenuItems = [
            ...
            { id: 'sl6', category: 'salad', nameEn: 'Waffle Fruit', nameAm: 'ዋፍል ፍሩት', price: '450', image: 'https://images.pexels.com/photos/221063/pexels-photo-221063.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '15 min', available: true },

            // WRAP
            { id: 'w1', category: 'wrap', nameEn: 'Chicken Wrap', nameAm: 'የዶሮ ውራፕ', price: '620', image: '', prep: '15 min', available: true },
            ...
            // SANDWICH / CLUB
            { id: 'sw1', category: 'sandwich', nameEn: 'Tuna Sandwich', nameAm: 'ቱና ሳንድዊች', price: '580', image: '', prep: '12 min', available: true },
            ...
            { id: 'pz2', category: 'pizza', nameEn: 'Margarita Pizza', nameAm: 'ማርጋሪታ ፒዛ', price: '700', image: 'https://images.pexels.com/photos/2741457/pexels-photo-2741457.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '15 min', available: true },
            { id: 'pz3', category: 'pizza', nameEn: 'Meat Lover Pizza', nameAm: 'ሜት ላቨር ፒዛ', price: '770', image: '', prep: '20 min', available: true },
            { id: 'pz4', category: 'pizza', nameEn: 'Special Pizza', nameAm: 'ስፔሻል ፒዛ', price: '920', image: '', prep: '20 min', available: true },
            { id: 'pz5', category: 'pizza', nameEn: 'Chicken Pizza', nameAm: 'ቺከን ፒዛ', price: '890', image: '', prep: '20 min', available: true },
            { id: 'pz6', category: 'pizza', nameEn: 'Veg Pizza', nameAm: 'የአትክልት ፒዛ', price: '550', image: '', prep: '15 min', available: true },
            { id: 'pz7', category: 'pizza', nameEn: 'Tuna w/ Veg Pizza', nameAm: 'ቱና ከአትክልት ፒዛ', price: '690', image: '', prep: '20 min', available: true },
            { id: 'pz8', category: 'pizza', nameEn: 'Fasting Tuna Pizza', nameAm: 'የጾም ቱና ፒዛ', price: '650', image: '', prep: '15 min', available: true },
            { id: 'pz9', category: 'pizza', nameEn: 'Family Pizza', nameAm: 'ፋሚሊ ፒዛ', price: '1470', image: '', prep: '25 min', available: true },

            // EXTRA
            { id: 'ex1', category: 'extra', nameEn: 'Extra Cheese', nameAm: 'ተጨማሪ ቺዝ', price: '80', image: '', prep: 'Instant', available: true },
            { id: 'ex2', category: 'extra', nameEn: 'Extra Bread', nameAm: 'ተጨማሪ ዳቦ', price: '40', image: '', prep: 'Instant', available: true },
            { id: 'ex3', category: 'extra', nameEn: 'Extra Egg', nameAm: 'ተጨማሪ እንቁላል', price: '45', image: '', prep: '5 min', available: true },
            { id: 'ex4', category: 'extra', nameEn: 'Extra Mayonnaise', nameAm: 'ተጨማሪ ማዮኔዝ', price: '80', image: '', prep: 'Instant', available: true },
            { id: 'ex5', category: 'extra', nameEn: 'Juice Cup', nameAm: 'የጁስ ብርጭቆ', price: '25', image: '', prep: 'Instant', available: true },
            { id: 'ex6', category: 'extra', nameEn: 'Burger Box', nameAm: 'የበርገር ሳጥን', price: '50', image: '', prep: 'Instant', available: true },
            { id: 'ex7', category: 'extra', nameEn: 'Pizza Box', nameAm: 'የፒዛ ሳጥን', price: '85', image: '', prep: 'Instant', available: true },
            { id: 'ex8', category: 'extra', nameEn: 'Extra Tuna 1/2', nameAm: 'ተጨማሪ ቱና 1/2', price: '150', image: '', prep: 'Instant', available: true },
            { id: 'ex9', category: 'extra', nameEn: 'Extra Tuna', nameAm: 'ተጨማሪ ቱና', price: '270', image: '', prep: 'Instant', available: true },
            { id: 'ex10', category: 'extra', nameEn: 'Coffee Cup', nameAm: 'የቡና ብርጭቆ', price: '20', image: '', prep: 'Instant', available: true },

            // JUICE
            { id: 'j1', category: 'juice', nameEn: 'Avocado Mix', nameAm: 'አቮካዶ ሚክስ', price: '310 / 360', image: '', prep: '5 min', available: true },
            { id: 'j2', category: 'juice', nameEn: 'Avocado', nameAm: 'አቮካዶ ጁስ', price: '330 / 370', image: '', prep: '5 min', available: true },
            { id: 'j3', category: 'juice', nameEn: 'Mango', nameAm: 'ማንጎ ጁስ', price: '320 / 350', image: 'https://images.pexels.com/photos/4955257/pexels-photo-4955257.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'j4', category: 'juice', nameEn: 'Strawberry', nameAm: 'ስትሮቤሪ ጁስ', price: '300 / 350', image: '', prep: '5 min', available: true },
            { id: 'j5', category: 'juice', nameEn: 'Papaya', nameAm: 'ፓፓያ ጁስ', price: '250 / 270', image: '', prep: '5 min', available: true },
            { id: 'j6', category: 'juice', nameEn: 'Pineapple', nameAm: 'አናናስ ጁስ', price: '270 / 300', image: '', prep: '5 min', available: true },
            { id: 'j7', category: 'juice', nameEn: 'Watermelon', nameAm: 'ሐብሐብ ጁስ', price: '270 / 300', image: '', prep: '5 min', available: true },
            { id: 'j8', category: 'juice', nameEn: 'Mix Juice', nameAm: 'ሚክስ ጁስ', price: '250 / 290', image: '', prep: '5 min', available: true },
            { id: 'j9', category: 'juice', nameEn: 'Flaxseed Juice', nameAm: 'የተልባ ጁስ', price: '270 / 300', image: '', prep: '5 min', available: true },
            { id: 'j10', category: 'juice', nameEn: 'Sugarcane Juice', nameAm: 'የሸንኮራ አገዳ ጁስ', price: '220 / 240', image: '', prep: '5 min', available: true },
            { id: 'j11', category: 'juice', nameEn: 'Lemon Juice', nameAm: 'ሎሚ ጁስ', price: '220 / 240', image: '', prep: '5 min', available: true },
            { id: 'j12', category: 'juice', nameEn: 'Carrot Juice', nameAm: 'ካሮት ጁስ', price: '220 / 240', image: '', prep: '5 min', available: true },
            { id: 'j13', category: 'juice', nameEn: 'Ginger Juice', nameAm: 'ዝንጅብል ጁስ', price: '230 / 250', image: '', prep: '5 min', available: true },
            { id: 'j14', category: 'juice', nameEn: 'Mango Mix', nameAm: 'ማንጎ ሚክስ', price: '300 / 340', image: 'https://images.pexels.com/photos/14930490/pexels-photo-14930490.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'j15', category: 'juice', nameEn: 'Strawberry Mix', nameAm: 'ስትሮቤሪ ሚክስ', price: '300 / 340', image: '', prep: '5 min', available: true },
            { id: 'j16', category: 'juice', nameEn: 'Orange Mix', nameAm: 'ብርትኳን ሚክስ', price: '300 / 340', image: '', prep: '5 min', available: true },

            // SHAKE
            { id: 'sk1', category: 'shake', nameEn: 'Special Shake', nameAm: 'ስፔሻል ሼክ', price: '300 / 350', image: '', prep: '8 min', available: true },
            { id: 'sk2', category: 'shake', nameEn: 'Mango Shake', nameAm: 'ማንጎ ሼክ', price: '350 / 380', image: '', prep: '8 min', available: true },
            { id: 'sk3', category: 'shake', nameEn: 'Avocado Shake', nameAm: 'አቮካዶ ሼክ', price: '350 / 380', image: '', prep: '8 min', available: true },
            { id: 'sk4', category: 'shake', nameEn: 'Papaya Shake', nameAm: 'ፓፓያ ሼክ', price: '260 / 280', image: '', prep: '8 min', available: true },
            { id: 'sk5', category: 'shake', nameEn: 'Watermelon Shake', nameAm: 'ሐብሐብ ሼክ', price: '260 / 280', image: '', prep: '8 min', available: true },
            { id: 'sk6', category: 'shake', nameEn: 'Banana Shake', nameAm: 'ሙዝ ሼክ', price: '260 / 280', image: '', prep: '8 min', available: true },
            { id: 'sk7', category: 'shake', nameEn: 'Sugarcane Shake', nameAm: 'የሸንኮራ አገዳ ሼክ', price: '260 / 290', image: '', prep: '8 min', available: true },
            { id: 'sk8', category: 'shake', nameEn: 'Strawberry Shake', nameAm: 'ስትሮቤሪ ሼክ', price: '260 / 380', image: '', prep: '8 min', available: true },

            // MILK SHAKE
            { id: 'ms1', category: 'milkshake', nameEn: 'Chocolate Shake', nameAm: 'ቾኮሌት ሚልካ ሼክ', price: '420', image: '', prep: '8 min', available: true },
            { id: 'ms2', category: 'milkshake', nameEn: 'Oreo Shake', nameAm: 'ኦሪዮ ሚልካ ሼክ', price: '410', image: '', prep: '8 min', available: true },
            { id: 'ms3', category: 'milkshake', nameEn: 'Vanilla Shake', nameAm: 'ቫኒላ ሚልካ ሼክ', price: '350', image: '', prep: '8 min', available: true },
            { id: 'ms4', category: 'milkshake', nameEn: 'Mix Shake', nameAm: 'ሚክስ ሚልካ ሼክ', price: '340', image: '', prep: '8 min', available: true },
            { id: 'ms5', category: 'milkshake', nameEn: 'Protein Shake', nameAm: 'ፕሮቲን ሼክ', price: '480', image: '', prep: '8 min', available: true },
            { id: 'ms6', category: 'milkshake', nameEn: 'Family Shake', nameAm: 'ፋሚሊ ሼክ', price: '690', image: '', prep: '10 min', available: true },

            // MOJITO
            { id: 'mj1', category: 'mojito', nameEn: 'Strawberry Mojito', nameAm: 'ስትሮቤሪ ሞሂቶ', price: '295', image: 'https://images.pexels.com/photos/37662775/pexels-photo-37662775.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj2', category: 'mojito', nameEn: 'Orange Mojito', nameAm: 'ኦሬንጅ ሞሂቶ', price: '295', image: 'https://images.pexels.com/photos/4051220/pexels-photo-4051220.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj3', category: 'mojito', nameEn: 'Kiwi Mojito', nameAm: 'ኪዊ ሞሂቶ', price: '295', image: 'https://images.pexels.com/photos/4051265/pexels-photo-4051265.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj4', category: 'mojito', nameEn: 'Lemon Mojito', nameAm: 'ሌመን ሞሂቶ', price: '295', image: 'https://images.pexels.com/photos/7259054/pexels-photo-7259054.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj5', category: 'mojito', nameEn: 'Chocolate Mojito', nameAm: 'ቾኮሌት ሞሂቶ', price: '295', image: 'https://images.pexels.com/photos/33129959/pexels-photo-33129959.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj6', category: 'mojito', nameEn: 'Pineapple Mojito', nameAm: 'አናናስ ሞሂቶ', price: '300', image: 'https://images.pexels.com/photos/13772509/pexels-photo-13772509.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj7', category: 'mojito', nameEn: 'Special Mojito', nameAm: 'ስፔሻል ሞሂቶ', price: '300', image: 'https://images.pexels.com/photos/30591641/pexels-photo-30591641.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj8', category: 'mojito', nameEn: 'Avatar Mojito', nameAm: 'አቫታር ሞሂቶ', price: '300', image: 'https://images.pexels.com/photos/36580447/pexels-photo-36580447.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj9', category: 'mojito', nameEn: 'King Mojito', nameAm: 'ኪንግ ሞሂቶ', price: '295', image: 'https://images.pexels.com/photos/17377702/pexels-photo-17377702.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj10', category: 'mojito', nameEn: 'Sky Mojito', nameAm: 'ስካይ ሞሂቶ', price: '295', image: 'https://images.pexels.com/photos/26856730/pexels-photo-26856730.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },
            { id: 'mj11', category: 'mojito', nameEn: 'Snuzzy Mojito', nameAm: 'ስነዚ ሞሂቶ', price: '295', image: 'https://images.pexels.com/photos/30863689/pexels-photo-30863689.jpeg?auto=compress&cs=tinysrgb&w=500&h=400&fit=crop', prep: '5 min', available: true },

            // ICE ORDER
            { id: 'io1', category: 'iceorder', nameEn: 'Iced Tea', nameAm: 'አይስድ ቲ', price: '120', image: '', prep: '5 min', available: true },
            { id: 'io2', category: 'iceorder', nameEn: 'Ice Latte', nameAm: 'አይስ ላቴ', price: '230', image: '', prep: '5 min', available: true },
            { id: 'io3', category: 'iceorder', nameEn: 'Iced Caramel', nameAm: 'አይስ ካራሜል', price: '210', image: '', prep: '5 min', available: true },
            { id: 'io4', category: 'iceorder', nameEn: 'Iced Mocha', nameAm: 'አይስ ሞካ', price: '230', image: '', prep: '5 min', available: true },
            { id: 'io5', category: 'iceorder', nameEn: 'Iced Strawberry', nameAm: 'አይስ ስትሮቤሪ', price: '180', image: '', prep: '5 min', available: true },
            { id: 'io6', category: 'iceorder', nameEn: 'Iced Chocolate', nameAm: 'አይስ ቾኮሌት', price: '230', image: '', prep: '5 min', available: true },
            { id: 'io7', category: 'iceorder', nameEn: 'Lemonade', nameAm: 'ሌሞኔድ', price: '180', image: '', prep: '5 min', available: true },
            { id: 'io8', category: 'iceorder', nameEn: 'Strawberry w/ Chocolate', nameAm: 'ስትሮቤሪ ከቾኮሌት ጋር', price: '260', image: '', prep: '5 min', available: true },
            { id: 'io9', category: 'iceorder', nameEn: 'Caramel Ice Latte', nameAm: 'ካራሜል አይስ ላቴ', price: '260', image: '', prep: '5 min', available: true },
            { id: 'io10', category: 'iceorder', nameEn: 'Caramel Ice Coffee', nameAm: 'ካራሜል አይስ ቡና', price: '280', image: '', prep: '5 min', available: true },
            { id: 'io11', category: 'iceorder', nameEn: 'Ice Coffee', nameAm: 'አይስ ቡና', price: '240', image: '', prep: '5 min', available: true },
            { id: 'io12', category: 'iceorder', nameEn: 'Mixed Ice Latte', nameAm: 'ሚክስድ አይስ ላቴ', price: '350', image: '', prep: '5 min', available: true },

            // HOT DRINK
            { id: 'hd1', category: 'hotdrink', nameEn: 'Tea', nameAm: 'ሻይ', price: '70', image: '', prep: '3 min', available: true },
            { id: 'hd2', category: 'hotdrink', nameEn: 'Coffee', nameAm: 'ቡና', price: '140', image: '', prep: '5 min', available: true },
            { id: 'hd3', category: 'hotdrink', nameEn: 'Macchiato', nameAm: 'ማኪያቶ', price: '150', image: '', prep: '5 min', available: true },
            { id: 'hd4', category: 'hotdrink', nameEn: 'Spice Tea', nameAm: 'የቅመም ሻይ', price: '90', image: '', prep: '5 min', available: true },
            { id: 'hd5', category: 'hotdrink', nameEn: 'Espresso', nameAm: 'ኤስፕሬሶ', price: '150', image: '', prep: '3 min', available: true },
            { id: 'hd6', category: 'hotdrink', nameEn: 'Ginger Tea', nameAm: 'የዝንጅብል ሻይ', price: '90', image: '', prep: '5 min', available: true },
            { id: 'hd7', category: 'hotdrink', nameEn: 'Cappuccino', nameAm: 'ካፑቺኖ', price: '150', image: '', prep: '5 min', available: true },
            { id: 'hd8', category: 'hotdrink', nameEn: 'Latte', nameAm: 'ላቴ', price: '140', image: '', prep: '5 min', available: true },
            { id: 'hd9', category: 'hotdrink', nameEn: 'Milk', nameAm: 'ወተት', price: '140', image: '', prep: '3 min', available: true },
            { id: 'hd10', category: 'hotdrink', nameEn: 'Hot Chocolate', nameAm: 'ሆት ቾኮሌት', price: '150', image: '', prep: '5 min', available: true },
            { id: 'hd11', category: 'hotdrink', nameEn: 'Special Tea', nameAm: 'ስፔሻል ሻይ', price: '150', image: '', prep: '5 min', available: true },
            { id: 'hd12', category: 'hotdrink', nameEn: 'Mocha', nameAm: 'ሞካ', price: '130', image: '', prep: '5 min', available: true },

            // YOGURT
            { id: 'yg1', category: 'yogurt', nameEn: 'Caramel Yogurt', nameAm: 'ካራሜል እርጎ', price: '310', image: '', prep: '5 min', available: true },
            { id: 'yg2', category: 'yogurt', nameEn: 'Fruit Yogurt', nameAm: 'ፍሩት እርጎ', price: '310', image: '', prep: '5 min', available: true },
            { id: 'yg3', category: 'yogurt', nameEn: 'Flavored Yogurt', nameAm: 'ፍላቨርድ እርጎ', price: '310', image: '', prep: '5 min', available: true },
            { id: 'yg4', category: 'yogurt', nameEn: 'Strawberry Yogurt', nameAm: 'ስትሮቤሪ እርጎ', price: '310', image: '', prep: '5 min', available: true },

            // FRAPPUCCINO
            { id: 'fp1', category: 'frappuccino', nameEn: 'Chocolate Frappuccino', nameAm: 'ቾኮሌት ፍራፑቺኖ', price: '380', image: '', prep: '8 min', available: true },
            { id: 'fp2', category: 'frappuccino', nameEn: 'Caramel Frappuccino', nameAm: 'ካራሜል ፍራፑቺኖ', price: '330', image: '', prep: '8 min', available: true },
