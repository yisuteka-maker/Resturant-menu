...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 min-h-screen pb-20 md:pb-0 transition-colors duration-300">
    ...
    <!-- JAVASCRIPT CODE -->
    <script>
        // --- 1. CATEGORIES & ACCURATE MATCHED IMAGES ---
        const CATEGORIES = [
        ...
        // Direct image mapping to eliminate misaligned pictures
        const IMAGES = {
            avocado_food: "https://images.unsplash.com/photo-1525351484163-7529414344d8?w=500&auto=format&fit=crop",
            avocado_egg: "https://images.unsplash.com/photo-1588137378633-dea1336ce1e2?w=500&auto=format&fit=crop",
            waffle: "https://images.unsplash.com/photo-1562376552-0d160a2f238d?w=500&auto=format&fit=crop",
            pancake: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=500&auto=format&fit=crop",
            chechebsa: "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=500&auto=format&fit=crop",
            fetira: "https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=500&auto=format&fit=crop",
            omelet: "https://images.unsplash.com/photo-1510693206972-df098062cb71?w=500&auto=format&fit=crop",
            salad: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=500&auto=format&fit=crop",
            fruit_punch: "https://images.unsplash.com/photo-1490474418585-ba9bad8fd0ea?w=500&auto=format&fit=crop",
            wrap_chicken: "https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=500&auto=format&fit=crop",
            wrap_beef: "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=500&auto=format&fit=crop",
            sandwich_tuna: "https://images.unsplash.com/photo-1509722747041-616f39b57569?w=500&auto=format&fit=crop",
            sandwich_club: "https://images.unsplash.com/photo-1567234669003-dce7a7a88721?w=500&auto=format&fit=crop",
            sandwich_cheese: "https://images.unsplash.com/photo-1528735602780-2552fd46c7af?w=500&auto=format&fit=crop",
            burger_single: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500&auto=format&fit=crop",
            burger_double: "https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=500&auto=format&fit=crop",
            burger_cheese: "https://images.unsplash.com/photo-1550547660-d9450f859349?w=500&auto=format&fit=crop",
            burger_chicken: "https://images.unsplash.com/photo-1615297928064-24977384d0da?w=500&auto=format&fit=crop",
            pizza_margarita: "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500&auto=format&fit=crop",
            pizza_tuna: "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&auto=format&fit=crop",
            pizza_meat: "https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=500&auto=format&fit=crop",
            pizza_chicken: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&auto=format&fit=crop",
            pizza_veg: "https://images.unsplash.com/photo-1571407970349-bc81e7e96d47?w=500&auto=format&fit=crop",
            cheese_extra: "https://images.unsplash.com/photo-1552767059-ce182ead8c1b?w=500&auto=format&fit=crop",
            bread_extra: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=500&auto=format&fit=crop",
            juice_avocado: "https://images.unsplash.com/photo-1525351484163-7529414344d8?w=500&auto=format&fit=crop",
            juice_mango: "https://images.unsplash.com/photo-1553279768-865429fa0078?w=500&auto=format&fit=crop",
            juice_strawberry: "https://images.unsplash.com/photo-1546173159-315724a31696?w=500&auto=format&fit=crop",
            juice_papaya: "https://images.unsplash.com/photo-1517256064527-09c73fc73e38?w=500&auto=format&fit=crop",
            juice_pineapple: "https://images.unsplash.com/photo-1550258987-190a2d41a8ba?w=500&auto=format&fit=crop",
            juice_watermelon: "https://images.unsplash.com/photo-1587049352847-81a56d773cae?w=500&auto=format&fit=crop",
            juice_mix: "https://images.unsplash.com/photo-1613478223719-2ab802602423?w=500&auto=format&fit=crop",
            juice_lemon: "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=500&auto=format&fit=crop",
            shake_choco: "https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=500&auto=format&fit=crop",
            mojito: "https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=500&auto=format&fit=crop",
            ice_tea: "https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=500&auto=format&fit=crop",
            ice_coffee: "https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=500&auto=format&fit=crop",
            hot_tea: "https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=500&auto=format&fit=crop",
            hot_coffee: "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=500&auto=format&fit=crop",
            hot_macchiato: "https://images.unsplash.com/photo-1485808191679-5f86510681a2?w=500&auto=format&fit=crop",
            hot_cappuccino: "https://images.unsplash.com/photo-1534778101976-62847782c213?w=500&auto=format&fit=crop",
            yogurt: "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=500&auto=format&fit=crop"
        };

        let initialMenuItems = [
            // BREAKFAST
            { id: 'b1', category: 'breakfast', nameEn: 'Avocado', nameAm: 'አቮካዶ', price: '350', image: IMAGES.avocado_food, prep: '10 min', available: true },
            { id: 'b2', category: 'breakfast', nameEn: 'Avocado w/ Egg', nameAm: 'አቮካዶ ከእንቁላል ጋር', price: '370', image: IMAGES.avocado_egg, prep: '10 min', available: true },
            { id: 'b3', category: 'breakfast', nameEn: 'Waffle', nameAm: 'ዋፍል', price: '400', image: IMAGES.waffle, prep: '15 min', available: true },
            { id: 'b4', category: 'breakfast', nameEn: 'Pancake', nameAm: 'ፓንኬክ', price: '400', image: IMAGES.pancake, prep: '15 min', available: true },
            { id: 'b5', category: 'breakfast', nameEn: 'Chechebsa Normal', nameAm: 'ጨጨብሳ', price: '330', image: IMAGES.chechebsa, prep: '15 min', available: true },
            { id: 'b6', category: 'breakfast', nameEn: 'Chechebsa Special', nameAm: 'ስፔሻል ጨጨብሳ', price: '400', image: IMAGES.chechebsa, prep: '15 min', available: true },
            { id: 'b7', category: 'breakfast', nameEn: 'Avocado Toast', nameAm: 'አቮካዶ ቶስት', price: '320', image: IMAGES.avocado_egg, prep: '10 min', available: true },
            { id: 'b8', category: 'breakfast', nameEn: 'Special Fetira', nameAm: 'ስፔሻል ፈቲራ', price: '360', image: IMAGES.fetira, prep: '15 min', available: true },
            { id: 'b9', category: 'breakfast', nameEn: 'Normal Fetira', nameAm: 'ፈቲራ', price: '260', image: IMAGES.fetira, prep: '15 min', available: true },
            { id: 'b10', category: 'breakfast', nameEn: 'Omelet w/ Cheese', nameAm: 'ኦምሌት ከቺዝ ጋር', price: '430', image: IMAGES.omelet, prep: '10 min', available: true },
            { id: 'b11', category: 'breakfast', nameEn: 'Normal Omelet', nameAm: 'ኦምሌት', price: '350', image: IMAGES.omelet, prep: '10 min', available: true },

            // SALAD / FRUIT
            { id: 'sl1', category: 'salad', nameEn: 'Normal Salad', nameAm: 'ሰላጣ', price: '400', image: IMAGES.salad, prep: '10 min', available: true },
            { id: 'sl2', category: 'salad', nameEn: 'Special Salad', nameAm: 'ስፔሻል ሰላጣ', price: '590', image: IMAGES.salad, prep: '12 min', available: true },
            { id: 'sl3', category: 'salad', nameEn: 'Normal Fruit Punch', nameAm: 'ፍሩት ፓንች', price: '350', image: IMAGES.fruit_punch, prep: '10 min', available: true },
            { id: 'sl4', category: 'salad', nameEn: 'Special Fruit Punch', nameAm: 'ስፔሻል ፍሩት ፓንች', price: '450', image: IMAGES.fruit_punch, prep: '10 min', available: true },
            { id: 'sl5', category: 'salad', nameEn: 'Four in One', nameAm: 'ፎር ኢን ዋን', price: '580', image: IMAGES.fruit_punch, prep: '12 min', available: true },
            { id: 'sl6', category: 'salad', nameEn: 'Waffle Fruit', nameAm: 'ዋፍል ፍሩት', price: '450', image: IMAGES.waffle, prep: '15 min', available: true },

            // WRAP
            { id: 'w1', category: 'wrap', nameEn: 'Chicken Wrap', nameAm: 'የዶሮ ውራፕ', price: '620', image: IMAGES.wrap_chicken, prep: '15 min', available: true },
            { id: 'w2', category: 'wrap', nameEn: 'Beef Wrap', nameAm: 'የስጋ ውራፕ', price: '570', image: IMAGES.wrap_beef, prep: '15 min', available: true },
            { id: 'w3', category: 'wrap', nameEn: 'Veg Wrap', nameAm: 'የአትክልት ውራፕ', price: '450', image: IMAGES.wrap_chicken, prep: '10 min', available: true },

            // SANDWICH / CLUB
            { id: 'sw1', category: 'sandwich', nameEn: 'Tuna Sandwich', nameAm: 'ቱና ሳንድዊች', price: '580', image: IMAGES.sandwich_tuna, prep: '12 min', available: true },
            { id: 'sw2', category: 'sandwich', nameEn: 'Egg Sandwich', nameAm: 'እንቁላል ሳንድዊች', price: '400', image: IMAGES.sandwich_tuna, prep: '10 min', available: true },
            { id: 'sw3', category: 'sandwich', nameEn: 'Veg Sandwich', nameAm: 'የአትክልት ሳንድዊች', price: '350', image: IMAGES.sandwich_tuna, prep: '10 min', available: true },
            { id: 'sw4', category: 'sandwich', nameEn: 'Cheese Sandwich', nameAm: 'ቺዝ ሳንድዊች', price: '460', image: IMAGES.sandwich_cheese, prep: '10 min', available: true },
            { id: 'sw5', category: 'sandwich', nameEn: 'Special Club', nameAm: 'ስፔሻል ክለብ ሳንድዊች', price: '620', image: IMAGES.sandwich_club, prep: '15 min', available: true },
            { id: 'sw6', category: 'sandwich', nameEn: 'Beef Club', nameAm: 'ቢፍ ክለብ ሳንድዊች', price: '550', image: IMAGES.sandwich_club, prep: '15 min', available: true },
            { id: 'sw7', category: 'sandwich', nameEn: 'Chicken Club', nameAm: 'ቺከን ክለብ ሳንድዊች', price: '590', image: IMAGES.sandwich_club, prep: '15 min', available: true },
            { id: 'sw8', category: 'sandwich', nameEn: 'Egg w/ Cheese', nameAm: 'እንቁላል ከቺዝ ጋር', price: '500', image: IMAGES.sandwich_cheese, prep: '10 min', available: true },

            // BURGER
            { id: 'bg1', category: 'burger', nameEn: 'Special Double Burger', nameAm: 'ስፔሻል ዳብል በርገር', price: '800', image: IMAGES.burger_double, prep: '20 min', available: true },
            { id: 'bg2', category: 'burger', nameEn: 'Special Single Burger', nameAm: 'ስፔሻል ሲንግል በርገር', price: '680', image: IMAGES.burger_single, prep: '15 min', available: true },
            { id: 'bg3', category: 'burger', nameEn: 'Beef Burger', nameAm: 'ቢፍ በርገር', price: '630', image: IMAGES.burger_single, prep: '15 min', available: true },
            { id: 'bg4', category: 'burger', nameEn: 'Cheese Burger', nameAm: 'ቺዝ በርገር', price: '650', image: IMAGES.burger_cheese, prep: '15 min', available: true },
            { id: 'bg5', category: 'burger', nameEn: 'Chicken Burger', nameAm: 'ቺከን በርገር', price: '750', image: IMAGES.burger_chicken, prep: '15 min', available: true },

            // PIZZA
            { id: 'pz1', category: 'pizza', nameEn: 'Tuna w/ Cheese Pizza', nameAm: 'ቱና ከቺዝ ፒዛ', price: '770', image: IMAGES.pizza_tuna, prep: '20 min', available: true },
            { id: 'pz2', category: 'pizza', nameEn: 'Margarita Pizza', nameAm: 'ማርጋሪታ ፒዛ', price: '700', image: IMAGES.pizza_margarita, prep: '15 min', available: true },
            { id: 'pz3', category: 'pizza', nameEn: 'Meat Lover Pizza', nameAm: 'ሜት ላቨር ፒዛ', price: '770', image: IMAGES.pizza_meat, prep: '20 min', available: true },
            { id: 'pz4', category: 'pizza', nameEn: 'Special Pizza', nameAm: 'ስፔሻል ፒዛ', price: '920', image: IMAGES.pizza_meat, prep: '20 min', available: true },
            { id: 'pz5', category: 'pizza', nameEn: 'Chicken Pizza', nameAm: 'ቺከን ፒዛ', price: '890', image: IMAGES.pizza_chicken, prep: '20 min', available: true },
            { id: 'pz6', category: 'pizza', nameEn: 'Veg Pizza', nameAm: 'የአትክልት ፒዛ', price: '550', image: IMAGES.pizza_veg, prep: '15 min', available: true },
            { id: 'pz7', category: 'pizza', nameEn: 'Tuna w/ Veg Pizza', nameAm: 'ቱና ከአትክልት ፒዛ', price: '690', image: IMAGES.pizza_tuna, prep: '20 min', available: true },
            { id: 'pz8', category: 'pizza', nameEn: 'Fasting Tuna Pizza', nameAm: 'የጾም ቱና ፒዛ', price: '650', image: IMAGES.pizza_tuna, prep: '15 min', available: true },
            { id: 'pz9', category: 'pizza', nameEn: 'Family Pizza', nameAm: 'ፋሚሊ ፒዛ', price: '1470', image: IMAGES.pizza_margarita, prep: '25 min', available: true },

            // EXTRA
            { id: 'ex1', category: 'extra', nameEn: 'Extra Cheese', nameAm: 'ተጨማሪ ቺዝ', price: '80', image: IMAGES.cheese_extra, prep: 'Instant', available: true },
            { id: 'ex2', category: 'extra', nameEn: 'Extra Bread', nameAm: 'ተጨማሪ ዳቦ', price: '40', image: IMAGES.bread_extra, prep: 'Instant', available: true },
            { id: 'ex3', category: 'extra', nameEn: 'Extra Egg', nameAm: 'ተጨማሪ እንቁላል', price: '45', image: IMAGES.omelet, prep: '5 min', available: true },
            { id: 'ex4', category: 'extra', nameEn: 'Extra Mayonnaise', nameAm: 'ተጨማሪ ማዮኔዝ', price: '80', image: IMAGES.cheese_extra, prep: 'Instant', available: true },

            // JUICE
            { id: 'j1', category: 'juice', nameEn: 'Avocado Mix', nameAm: 'አቮካዶ ሚክስ', price: '310 / 360', image: IMAGES.juice_avocado, prep: '5 min', available: true },
            { id: 'j2', category: 'juice', nameEn: 'Avocado', nameAm: 'አቮካዶ ጁስ', price: '330 / 370', image: IMAGES.juice_avocado, prep: '5 min', available: true },
            { id: 'j3', category: 'juice', nameEn: 'Mango', nameAm: 'ማንጎ ጁስ', price: '320 / 350', image: IMAGES.juice_mango, prep: '5 min', available: true },
            { id: 'j4', category: 'juice', nameEn: 'Strawberry', nameAm: 'ስትሮቤሪ ጁስ', price: '300 / 350', image: IMAGES.juice_strawberry, prep: '5 min', available: true },
            { id: 'j5', category: 'juice', nameEn: 'Papaya', nameAm: 'ፓፓያ ጁስ', price: '250 / 270', image: IMAGES.juice_papaya, prep: '5 min', available: true },
            { id: 'j6', category: 'juice', nameEn: 'Pineapple', nameAm: 'አናናስ ጁስ', price: '270 / 300', image: IMAGES.juice_pineapple, prep: '5 min', available: true },
            { id: 'j7', category: 'juice', nameEn: 'Watermelon', nameAm: 'ሐብሐብ ጁስ', price: '270 / 300', image: IMAGES.juice_watermelon, prep: '5 min', available: true },
            { id: 'j8', category: 'juice', nameEn: 'Mix Juice', nameAm: 'ሚክስ ጁስ', price: '250 / 290', image: IMAGES.juice_mix, prep: '5 min', available: true },
            { id: 'j11', category: 'juice', nameEn: 'Lemon Juice', nameAm: 'ሎሚ ጁስ', price: '220 / 240', image: IMAGES.juice_lemon, prep: '5 min', available: true },

            // SHAKE & MILKSHAKE
            { id: 'sk1', category: 'shake', nameEn: 'Special Shake', nameAm: 'ስፔሻል ሼክ', price: '300 / 350', image: IMAGES.shake_choco, prep: '8 min', available: true },
            { id: 'ms1', category: 'milkshake', nameEn: 'Chocolate Shake', nameAm: 'ቾኮሌት ሚልካ ሼክ', price: '420', image: IMAGES.shake_choco, prep: '8 min', available: true },

            // MOJITO
            { id: 'mj1', category: 'mojito', nameEn: 'Strawberry Mojito', nameAm: 'ስትሮቤሪ ሞሂቶ', price: '295', image: IMAGES.mojito, prep: '5 min', available: true },

            // ICE ORDER
            { id: 'io1', category: 'iceorder', nameEn: 'Iced Tea', nameAm: 'አይስድ ቲ', price: '120', image: IMAGES.ice_tea, prep: '5 min', available: true },
            { id: 'io2', category: 'iceorder', nameEn: 'Ice Latte', nameAm: 'አይስ ላቴ', price: '230', image: IMAGES.ice_coffee, prep: '5 min', available: true },

            // HOT DRINK
            { id: 'hd1', category: 'hotdrink', nameEn: 'Tea', nameAm: 'ሻይ', price: '70', image: IMAGES.hot_tea, prep: '3 min', available: true },
            { id: 'hd2', category: 'hotdrink', nameEn: 'Coffee', nameAm: 'ቡና', price: '140', image: IMAGES.hot_coffee, prep: '5 min', available: true },
            { id: 'hd3', category: 'hotdrink', nameEn: 'Macchiato', nameAm: 'ማኪያቶ', price: '150', image: IMAGES.hot_macchiato, prep: '5 min', available: true },
            { id: 'hd7', category: 'hotdrink', nameEn: 'Cappuccino', nameAm: 'ካፑቺኖ', price: '150', image: IMAGES.hot_cappuccino, prep: '5 min', available: true },

            // YOGURT
            { id: 'yg1', category: 'yogurt', nameEn: 'Fruit Yogurt', nameAm: 'ፍሩት እርጎ', price: '310', image: IMAGES.yogurt, prep: '5 min', available: true }
        ];

        // --- 2. STATE MANAGEMENT ---
        let menuItems = JSON.parse(localStorage.getItem('ero_menu_items_v2')) || initialMenuItems;
        ...
        function saveMenuItem(event) {
            ...
            localStorage.setItem('ero_menu_items_v2', JSON.stringify(menuItems));
            renderMenuItems();
            renderHomeSpecials();
            closeFormModal();
        }
